  ...
  return (
    <>
      ...
      <div className="flex flex-col bg-white p-4">
        ...
        <div className="flex flex-col gap-2 md:gap-4">
          ...
          <div className="flex md:justify-center justify-around p-4 md:space-x-36 md:p-4 flex-wrap">
            <div className="card w-64 p-4 flex justify-center flex-col text-center h-fit ">
              ...
              />
              <p className="text-D_Grey font-bold text-xl">Membership<br />Organisations</p>
        ...
        <div className="flex justify-center p-4 border-2 border-black">
          <div className="for-home2 flex md:w-1/2">
            <div className="hidden md:block">
              <img src={Home2} alt="home2 photo" className="w-full" />
            </div>
            <div className="flex gap-2 md:gap-4 flex-col">
              <p className="text-start text-D_Grey text-xl md:text-3xl font-bold">The unseen of spending three years at Pixelgrade</p>
              <p className="text-start text-Grey text-sm">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed sit amet justo ipsum. Sed accumsan quam vitae est varius fringilla. Pellentesque placerat vestibulum lorem sed porta. Nullam mattis tristique iaculis. Nullam pulvinar sit amet risus pretium auctor. Etiam quis massa pulvinar, aliquam quam vitae, tempus sem. Donec elementum pulvinar odio.</p>
              <button className="text-start w-fit pl-4 pr-4 pt-2 pb-2 bg-customGreen text-white">Learn More</button>
            </div>
          </div>
        </div>
      </div>
